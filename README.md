...
Majority of the code is from [ultimate sd upscale](https://github.com/Coyote-A/ultimate-upscale-for-automatic1111), [wd1.4 tagger](https://github.com/toriato/stable-diffusion-webui-wd14-tagger), and [sd-scripts](https://github.com/kohya-ss/sd-scripts)
